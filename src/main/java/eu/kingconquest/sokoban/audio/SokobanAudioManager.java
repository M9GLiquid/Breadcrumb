...
public class SokobanAudioManager extends AudioManager {
    ...
    public static final SokobanAudioManager CRATE_AUDIO = new SokobanAudioManager("sokoban/audio/crate_move.wav", 0.8f);
    public static final SokobanAudioManager PLAYER_AUDIO = new SokobanAudioManager("sokoban/audio/player_move.wav", 1f);
